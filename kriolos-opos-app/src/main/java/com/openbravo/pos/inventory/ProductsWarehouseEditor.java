...
public class ProductsWarehouseEditor extends javax.swing.JPanel implements EditorRecord {
    ...
    public void writeValueEdit(Object value) {
        ...
        m_jLocationName.setText("Ubicación: " + (String)myprod[5]);
        m_jAddress.setText("Dirección: " + (String)myprod[6]);
        m_jPhone.setText("Teléfono: " + (String)myprod[7]);

        Double quantity = (Double)myprod[10];
        originalQuantity = quantity; // Guardar cantidad original
        m_jQuantity.setText(Formats.DOUBLE.formatValue(quantity));
        m_jMinimum.setText(Formats.DOUBLE.formatValue((Double)myprod[8]));
        m_jMaximum.setText(Formats.DOUBLE.formatValue((Double)myprod[9]));
        m_jQuantity.setEnabled(true);
        m_jMinimum.setEnabled(true);
        m_jMaximum.setEnabled(true);
     }
    ...
    public void writeValueDelete(Object value) {
        ...
        m_jAddress.setText("Dirección: " + (String)myprod[6]);
        m_jPhone.setText("Teléfono: " + (String)myprod[7]);
        m_jQuantity.setText(Formats.DOUBLE.formatValue((Double)myprod[10]));
        m_jMinimum.setText(Formats.DOUBLE.formatValue((Double)myprod[8]));
        m_jMaximum.setText(Formats.DOUBLE.formatValue((Double)myprod[9]));
        m_jQuantity.setEnabled(false);
        m_jMinimum.setEnabled(false);
    ...
    public Object createValue() throws BasicException {
        return new Object[] {
            ...
            prodname,
            location,
            null, // Location Name (readonly)
            null, // Address (readonly)
            null, // Phone (readonly)
    ...
    private void initComponents() {
        ...
        m_jLocationName = new javax.swing.JLabel();
        m_jAddress = new javax.swing.JLabel();
        m_jPhone = new javax.swing.JLabel();
        ...
        m_jLocationName.setFont(new java.awt.Font("Arial", 1, 14)); // NOI18N
        m_jLocationName.setForeground(new java.awt.Color(51, 51, 51));

        m_jAddress.setFont(new java.awt.Font("Arial", 0, 12)); // NOI18N
        m_jAddress.setForeground(new java.awt.Color(102, 102, 102));

        m_jPhone.setFont(new java.awt.Font("Arial", 0, 12)); // NOI18N
        m_jPhone.setForeground(new java.awt.Color(102, 102, 102));
        ...
        layout.setHorizontalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addComponent(m_jLocationName, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                    .addComponent(m_jAddress, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                    .addComponent(m_jPhone, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                    .addGroup(layout.createSequentialGroup()
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addGroup(layout.createSequentialGroup()
        ...
        layout.setVerticalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addComponent(m_jLocationName, javax.swing.GroupLayout.PREFERRED_SIZE, 25, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addGap(2, 2, 2)
                .addComponent(m_jAddress, javax.swing.GroupLayout.PREFERRED_SIZE, 20, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addGap(2, 2, 2)
                .addComponent(m_jPhone, javax.swing.GroupLayout.PREFERRED_SIZE, 20, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addGap(18, 18, 18)
    ...
    private javax.swing.JLabel m_jAddress;
    private javax.swing.JLabel m_jPhone;
    private javax.swing.JLabel m_jLocationName;
