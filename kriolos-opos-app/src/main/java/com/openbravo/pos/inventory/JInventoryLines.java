...
public class JInventoryLines extends javax.swing.JPanel {
    ...
    public void setEditable(boolean editable) {
        m_inventorylines.setEditable(editable);
    }
    
    public void addTableModelListener(javax.swing.event.TableModelListener l) {
        m_inventorylines.addTableModelListener(l);
    }
...
// JG 16 May 2013 use diamond inference        
        ...
        public void setValueAt(Object aValue, int row, int column) {
            ...
            try {
                switch (column) {
                    case 1: // Cantidad
                        String qtyStr = aValue.toString().replace("x", "").trim();
                        i.setMultiply((Double) Formats.DOUBLE.parseValue(qtyStr));
                        break;
                    case 2: // Precio
                        i.setPrice((Double) Formats.CURRENCY.parseValue(aValue.toString()));
                        break;
                }
        ...
        public boolean isCellEditable(int row, int column) {
            return m_bEditable && (column == 1 || column == 2);
        }
