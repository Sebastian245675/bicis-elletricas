...
public class JProductFinder extends javax.swing.JDialog {
    ...
    private ProductInfoExt init(DataLogicSales dlSales, int productsType) {
        ...
        // Evobike - Estilo Premium para el Buscador
        getContentPane().setBackground(java.awt.Color.WHITE);
        jPanel2.setBackground(java.awt.Color.WHITE);
        jPanel3.setBackground(java.awt.Color.WHITE);
        jPanel5.setBackground(java.awt.Color.WHITE);
        jPanel1.setBackground(java.awt.Color.WHITE);
        m_jProductSelect.setBackground(java.awt.Color.WHITE);

        jScrollPane1.getVerticalScrollBar().setPreferredSize(new Dimension(8, 8)); // Más fino
        jScrollPane1.getHorizontalScrollBar().setPreferredSize(new Dimension(8, 8));        

        ProductFilterSales jproductfilter = new ProductFilterSales(dlSales, null);
