...
public class SupabaseServiceManager {
    ...
    private static final String INTERNAL_SUPABASE_URL = "https://knysrejfucsooraqbqeq.supabase.co/rest/v1";
    private static final String INTERNAL_SUPABASE_API_KEY = "sb_secret_SnmqV0Botjup71JzZ9s-ZQ_D_IaABBC";
