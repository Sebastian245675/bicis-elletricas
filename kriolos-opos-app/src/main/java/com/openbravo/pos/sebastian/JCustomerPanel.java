...
public class JCustomerPanel extends JPanel implements JPanelView, BeanFactoryApp {
    ...
    // Colores Institucionales (Restaurando Tema Blanco)
    private static final Color SEBASTIAN_PRIMARY = new Color(46, 125, 50);    // Verde Esmeralda Corporativo
    private static final Color SEBASTIAN_SECONDARY = new Color(33, 150, 243); // Azul Material
    private static final Color SEBASTIAN_ACCENT = new Color(51, 98, 140);     // Azul Institucional
    private static final Color SEBASTIAN_LIGHT = Color.WHITE;                 // Fondo Blanco
    private static final Color SEBASTIAN_DARK = new Color(33, 33, 33);        // Texto Oscuro
    private static final Color SUCCESS_GREEN = new Color(46, 125, 50);        // Verde éxito
    private static final Color WARNING_ORANGE = new Color(255, 152, 0);       // Naranja
    private static final Color DANGER_RED = new Color(211, 47, 47);           // Rojo
    private static final Color INFO_BLUE = new Color(2, 136, 209);            // Azul info
    ...
    private JPanel createHeaderPanel() {
        ...
        JLabel titleLabel = new JLabel("Bicis MX - Gestión");
