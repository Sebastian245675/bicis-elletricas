...
public abstract class JPanelTicket extends JPanel implements JPanelView, TicketsEditor {
    ...
    private boolean m_bAutoDebt = false;
    ...
    public JPanelTicket(AppView app) {
        ...
        try {
            System.out.println("ðŸ”§ Inicializando sistema de puntos...");
            ...
            System.out.println("âœ… Sistema de puntos inicializado correctamente");
        } catch (Exception e) {
            System.err.println("âŒ Error inicializando sistema de puntos: " + e.getMessage());
            e.printStackTrace();
            LOGGER.log(java.util.logging.Level.SEVERE, "Error inicializando sistema de puntos: " + e.getMessage());
        }
        ...
        LOGGER.log(java.util.logging.Level.FINE, "JPanelTicket.init: criar: Ticket.Line");
        ...
        try {
            ...
            LOGGER.log(java.util.logging.Level.WARNING, "No se pudo aplicar estilo moderno: " + t.getMessage());
        }
    ...
    private void setupKeyboardShortcuts() {
            ...
            public void actionPerformed(java.awt.event.ActionEvent e) {
                try {
                    if (m_App.getAppUserView().getUser().hasPermission("com.openbravo.pos.panels.JPanelCloseMoney")) {
                        LOGGER.log(java.util.logging.Level.FINE, "F2 â†’ Corte de Caja: Abriendo panel de cierre");
                        m_App.getAppUserView().showTask("com.openbravo.pos.panels.JPanelCloseMoney");
                    } else {
                        java.awt.Toolkit.getDefaultToolkit().beep();
                        LOGGER.log(java.util.logging.Level.WARNING, "F2 â†’ Sin permiso para corte de caja");
                    }
                } catch (Exception ex) {
                    LOGGER.log(java.util.logging.Level.SEVERE,
                            "F2 â†’ Error abriendo corte de caja: " + ex.getMessage(), ex);
                }
            }
        });
        ...
        actionMap.put("historialPestañas", new javax.swing.AbstractAction() {
            ...
            public void actionPerformed(java.awt.event.ActionEvent e) {
                if (m_ticketsbag != null) {
                    LOGGER.log(java.util.logging.Level.FINE, "F3 â†’ Historial: Activando lista de tickets");
        ...
        actionMap.put("nuevaPestaña", new javax.swing.AbstractAction() {
            @Override
            public void actionPerformed(java.awt.event.ActionEvent e) {
                LOGGER.log(java.util.logging.Level.FINE, "F4 â†’ Nueva Pestaña: Creando nuevo ticket");
                createNewTicket();
            }
        });
        ...
        actionMap.put("asignarCliente", new javax.swing.AbstractAction() {
            @Override
            public void actionPerformed(java.awt.event.ActionEvent e) {
                LOGGER.log(java.util.logging.Level.FINE, "F5 â†’ Asignar Cliente: Abriendo modal de asignar cliente");
        ...
        actionMap.put("eliminarLinea", new javax.swing.AbstractAction() {
            ...
            public void actionPerformed(java.awt.event.ActionEvent e) {
                if (m_jDelete != null && m_jDelete.isEnabled() && m_oTicket != null && m_oTicket.getLinesCount() > 0) {
                    LOGGER.log(java.util.logging.Level.FINE, "F6 â†’ Eliminar Línea");
                    m_jDelete.doClick();
                } else {
                    java.awt.Toolkit.getDefaultToolkit().beep();
                }
        ...
        actionMap.put("entradas", new javax.swing.AbstractAction() {
            @Override
            public void actionPerformed(java.awt.event.ActionEvent e) {
                LOGGER.log(java.util.logging.Level.FINE, "F7 â†’ Entradas: Abriendo diálogo de entradas");
                showEntradasDialog();
            }
        });
        ...
        actionMap.put("salidas", new javax.swing.AbstractAction() {
            @Override
            public void actionPerformed(java.awt.event.ActionEvent e) {
                LOGGER.log(java.util.logging.Level.FINE, "F8 â†’ Salidas: Abriendo diálogo de salidas");
                showSalidasDialog();
            }
        });
        ...
        actionMap.put("atributos", new javax.swing.AbstractAction() {
            ...
            public void actionPerformed(java.awt.event.ActionEvent e) {
                if (jEditAttributes != null && jEditAttributes.isEnabled() && m_oTicket != null
                    ...
                    LOGGER.log(java.util.logging.Level.FINE, "F9 â†’ Atributos");
        ...
        // F10: Apartar Vehículo
        inputMap.put(javax.swing.KeyStroke.getKeyStroke(java.awt.event.KeyEvent.VK_F10, 0), "apartarVehiculo");
        actionMap.put("apartarVehiculo", new javax.swing.AbstractAction() {
            @Override
            public void actionPerformed(java.awt.event.ActionEvent e) {
                if (btnApartar != null && btnApartar.isEnabled()) {
                    LOGGER.log(java.util.logging.Level.FINE, "F10 â†’ Apartar Vehículo");
                    showApartarDialog();
                }
            }
        });

        // Shift + F10: Dividir ticket
        inputMap.put(javax.swing.KeyStroke.getKeyStroke(java.awt.event.KeyEvent.VK_F10,
                java.awt.event.InputEvent.SHIFT_DOWN_MASK), "dividirTicket");
        actionMap.put("dividirTicket", new javax.swing.AbstractAction() {
            @Override
            public void actionPerformed(java.awt.event.ActionEvent e) {
                if (btnSplit != null && btnSplit.isEnabled()) {
                    LOGGER.log(java.util.logging.Level.FINE, "Shift+F10 â†’ Dividir Ticket");
                    btnSplit.doClick();
                } else {
                    java.awt.Toolkit.getDefaultToolkit().beep();
                }
            ...
            public void actionPerformed(java.awt.event.ActionEvent e) {
                if (m_oTicket != null && m_oTicket.getLinesCount() > 0) {
                    if (m_jPayNow != null && m_jPayNow.isEnabled()) {
                        LOGGER.log(java.util.logging.Level.FINE, "F12 â†’ Cobrar: Simulando clic en botón Pagar");
                        m_jPayNow.doClick();
                    }
                } else {
                    java.awt.Toolkit.getDefaultToolkit().beep();
        ...
        LOGGER.log(java.util.logging.Level.INFO,
                "âœ… Atajos de teclado configurados: F2=Corte, F3=Historial, F4=Nueva, F5=Asignar Cliente, F6=Eliminar, F7=Entradas, F8=Salidas, F9=Atributos, F10=Apartar, F12=Cobrar");
        ...
        for (java.awt.Component comp : components) {
            if (comp instanceof javax.swing.JButton) {
                ...
                if (btnKey != null && !btnKey.isEmpty()) {
                    // Asignar atajos segÃºn el tipo de botón
    ...
    private void updateButtonTextsWithShortcuts() {
        // Actualizar botón de cliente (F5 ahora es para asignar cliente, no este
        // botón)
    ...
    private void initExtButtons() {
        ...
        if (sConfigRes == null || sConfigRes.isBlank()) {
            LOGGER.log(java.util.logging.Level.WARNING, "No found XML resource: " + resourceName);
            sConfigRes = "";
        }
        ...
        m_jbtnconfig = new JPanelButtons(m_App, new JPanelButtons.JPanelButtonListener() {
            ...
            public void eval(String resource) {
                ...
                LOGGER.log(java.util.logging.Level.INFO, "Rrocessing code (resource id): " + resource);
            ...
            public void print(String resource) {
                ...
                LOGGER.log(java.util.logging.Level.INFO, "Rrocessing template (resource id): " + resource);
        ...
        panelBotones.setLayout(new java.awt.GridLayout(4, 1, 5, 5));
        ...
        btnHistorial.setPreferredSize(new java.awt.Dimension(120, 35));
        btnHistorial.setFont(new java.awt.Font("Arial", java.awt.Font.BOLD, 14));
        ...
        // Botón 4 - Entradas y Salidas (F7/F8)
        btnEntradasSalidasCustom = new javax.swing.JButton(
                "<html><center>F7 Ent / F8 Sal</center></html>");
        btnEntradasSalidasCustom.setPreferredSize(new java.awt.Dimension(120, 35));
        btnEntradasSalidasCustom.setFont(new java.awt.Font("Arial", java.awt.Font.BOLD, 12));
        ...
        btnEntradasSalidasCustom.addActionListener(e -> {
            // Abrir diálogo de Entradas y Salidas (sin tipo fijo para que el usuario
            // elija)
    ...
    private void initComponentFromChild() {
        ...
        // Sebastian - Configurar layout completo para m_jPanelCatalog para que el
        // JCatalog
    ...
    private void saveCurrentTicket() {
        ...
        if (m_oTicket != null) {
            ...
            try {
                ...
                LOGGER.log(java.util.logging.Level.SEVERE, "Exception on save current ticket: " + currentTicket, ex);
            }
        }
    }
    ...
    public void activate() throws BasicException {
        ...
        LOGGER.log(java.util.logging.Level.INFO, "JPanelTicket.activate");

        // Sebastian - Forzar moneda de México ($) y formato regional
        java.util.Locale.setDefault(java.util.Locale.forLanguageTag("es-MX"));
        ...
        if (isAutoLogout()) {
            try {
                ...
                LOGGER.log(java.util.logging.Level.WARNING, "Exception on set auto logout timer: ", ex);
            }
        }
        ...
        try {
            ...
            try {
                java.io.FileWriter fw = new java.io.FileWriter(
                        "c:\\Users\\USUARIO\\Downloads\\bicis_mx\\bici\\punto-mx\\app-errors.log", true);
            ...
            LOGGER.log(java.util.logging.Level.INFO, "Template Printer.Ticket actualizado en la base de datos");
            ...
            LOGGER.log(java.util.logging.Level.SEVERE, "Error leyendo el archivo Printer.Ticket.xml: " + errorMsg);
            // #region agent log
            try {
                java.io.FileWriter fw = new java.io.FileWriter(
                        "c:\\Users\\USUARIO\\Downloads\\bicis_mx\\bici\\punto-mx\\app-errors.log", true);
            ...
            String errorMsg = e.getMessage() != null ? e.getMessage() : "Error desconocido";
            LOGGER.log(java.util.logging.Level.SEVERE, "Error actualizando template Printer.Ticket en BD: " + errorMsg);
            // #region agent log
            try {
                java.io.FileWriter fw = new java.io.FileWriter(
                        "c:\\Users\\USUARIO\\Downloads\\bicis_mx\\bici\\punto-mx\\app-errors.log", true);
    ...
    private void actualizarTemplateTicket2EnBD() {
        try {
            ...
            LOGGER.log(java.util.logging.Level.INFO, "Template Printer.Ticket2 actualizado en la base de datos");
            ...
            String errorMsg = e.getMessage() != null ? e.getMessage() : "Error desconocido";
            LOGGER.log(java.util.logging.Level.SEVERE, "Error leyendo el archivo Printer.Ticket2.xml: " + errorMsg);
        } catch (Exception e) {
            String errorMsg = e.getMessage() != null ? e.getMessage() : "Error desconocido";
            LOGGER.log(java.util.logging.Level.SEVERE,
                    "Error actualizando template Printer.Ticket2 en BD: " + errorMsg);
        }
    }
    ...
    private void aplicarFuentesGrandesVentas() {
        ...
        if (m_jTotalEuros != null) {
            m_jTotalEuros.setFont(new Font("Arial", Font.PLAIN, 52)); // Total estilo Eleventa - tamaÃ±o grande pero
                                                                      // delgado (PLAIN, tamaÃ±o 52)
    ...
    public boolean deactivate() {
        LOGGER.log(java.util.logging.Level.FINE, "JPanelTicket.deactivate");
        if (listener != null) {
            listener.stop();
        }
    ...
    public void setActiveTicket(TicketInfo ticketInfo, String oTicketExt) {
        ...
        LOGGER.log(java.util.logging.Level.FINE, "JPanelTicket setActiveTicket: " + oTicketExt);
        ...
        // Establecer foco automáticamente en el campo de búsqueda después de cambiar
        // de
        // ticket
        setSearchFieldFocus();
    }
    ...
    protected void refreshCatalogView() {
        // Sebastian - Se sobrescribe en JPanelTicketSales para alternar la barra lateral
    }
    ...
    private void addTicketLine(ProductInfoExt oProduct, double dMul, double dPrice) {
        ...
        LOGGER.log(java.util.logging.Level.INFO, "Product onoProduct.isVprice: ", oProduct.isVprice());
        if (oProduct.isVprice()) {
            ...
            try {
                ...
                LOGGER.log(java.util.logging.Level.WARNING, "Could not check product stock", ex);
            ...
            if (oProduct.isService()) {
                LOGGER.log(java.util.logging.Level.INFO,
                        "Adding product marked as SERVICE to ticket: " + oProduct.getID()
            ...
            if (oLine.isProductCom()) {
                ...
                if (!foundMatchingLine) {
                    ...
                    try {
                        ...
                        LOGGER.log(java.util.logging.Level.WARNING, "Exception on: ", ex);
                        MessageInf msg = new MessageInf(MessageInf.SGN_WARNING,
    ...
    private void applyPromotions(TicketLineInfo line) {
        String pid = line.getProductID();
        String cid = line.getProductCategoryID();
        if (pid == null) {
            return;
        }

        try {
            Connection con = m_App.getSession().getConnection();
            Timestamp now = new Timestamp(System.currentTimeMillis());

            LOGGER.log(Level.INFO, "Checking promotions for Product: {0}, Category: {1} at {2}", new Object[]{pid, cid, now});

            // 1. Check Product Promotion first
            PreparedStatement ps = con.prepareStatement(
                    "SELECT DISCOUNT, NAME FROM PROMOTIONS "
                    + "WHERE TARGET_TYPE = 0 AND TARGET_ID = ? "
            ...
            if (rs.next()) {
                ...
                double originalPrice = line.getPrice();
                double newPrice = originalPrice * (1.0 - (discount / 100.0));

                line.setPrice(newPrice);
                line.setProperty("promotion.name", promoName);
                line.setProperty("promotion.discount", String.valueOf(discount));
                
                // Añadir indicador visual al nombre del producto
                String originalName = line.getProperty("product.name");
                line.setProperty("product.name", originalName + " [" + (int)discount + "% OFF]");
                
                LOGGER.log(Level.INFO, "Applied product promotion: {0} ({1}%) to {2}", new Object[]{promoName, discount, pid});
                return;
            }

            // 2. If no product promotion, check Category Promotion
            if (cid != null) {
                ps = con.prepareStatement(
                        "SELECT DISCOUNT, NAME FROM PROMOTIONS "
                        + "WHERE TARGET_TYPE = 1 AND TARGET_ID = ? "
                        + "AND DATE_START <= ? AND DATE_END >= ? "
                        + "ORDER BY DISCOUNT DESC"
                );
                ps.setString(1, cid);
                ...
                if (rs.next()) {
                    ...
                    LOGGER.log(Level.INFO, "Applied category promotion: {0} ({1}%) to category {2}", new Object[]{promoName, discount, cid});
                }
            }
        } catch (SQLException ex) {
            LOGGER.log(Level.WARNING, "Error applying promotions", ex);
        }
    }
    ...
    private void agregarProductoVarios() {
        ...
        if (result == javax.swing.JOptionPane.OK_OPTION) {
            try {
                ...
                // Ajustar precio segÃºn si incluye impuestos o no
                ...
                msg.show(this);
                LOGGER.log(java.util.logging.Level.WARNING, "Error agregando producto varios", ex);
            }
        }
    }
        ...
        try {
            ...
            if (oProduct == null) {
                try {
                    ...
                    LOGGER.log(java.util.logging.Level.FINE, "No se encontró producto por referencia: " + sCode,
                            exRef);
                }
            }
        ...
        if ((cTrans == '\n') || (cTrans == '?')) {
            ...
            if (cTrans == '\u007f') {
                ...
                if (m_oTicket != null && m_oTicket.getLinesCount() > 0) {
                    ...
                    Toolkit.getDefaultToolkit().beep();
                    LOGGER.log(java.util.logging.Level.FINE, "Canno close Ticket, because m_oTicket is " + m_oTicket
    ...
    private void addWindowFocusListener() {
        ...
        // â”€â”€ LISTENER PRINCIPAL: KeyboardFocusManager
        ...
        m_focusRedirectListener = evt -> {
            ...
            // El foco fue a algÃºn componente no-editable de nuestra ventana:
        ...
        if (m_App.hasPermission("sales.Total")) {
            ...
            try {
                ...
                if (paymentdialog != null && executeEvent(ticket, ticketext, TicketConstants.EV_TICKET_TOTAL) == null) {
                    ...
                    // Sebastian - Si es un apartado, auto-seleccionar pestaña Deuda en el diálogo
                    // de pago
                    boolean isApartado = "true".equals(ticket.getProperty("is_apartado"));
                    paymentdialog.setAutoDebt(isApartado);

                    if (paymentdialog.showDialog(ticket.getTotal(), ticket.getCustomer())) {

                        // Sebastian - Restaurar foco en campo de búsqueda después de cerrar diálogo
                        // de
                        // pago
                        setSearchFieldFocus();
                        ...
                        if (scriptResult == null) {
                            try {
                                ...
                                LOGGER.log(java.util.logging.Level.SEVERE, "Exception on save ticket ", ex);
                            ...
                            try {
                                ...
                                LOGGER.log(java.util.logging.Level.SEVERE, "Exception on executeEvent: " + eventName,
                                        ex);
                            }
                            ...
                            if (paymentdialog.isPrintSelected() || warrantyPrint) {
                                try {
                                    ...
                                    LOGGER.log(java.util.logging.Level.SEVERE,
                                            "Exception on printTicket: Printer.Ticket",
                                            ex);
                                }
                            } else {
    ...
    private void printTicket(String sresourcename, TicketInfo ticket, String ticketext) {
        ...
        LOGGER.log(java.util.logging.Level.INFO, "Reading resource id: " + sresourcename);
        ...
        if (sresource == null) {
            LOGGER.log(java.util.logging.Level.WARNING, "NOTFOUND content for resource id: " + sresourcename);
            ...
            if (ticket.getPickupId() == 0) {
                try {
                    ...
                    LOGGER.log(java.util.logging.Level.WARNING, "Exception on get pickup id: ", ex);
            ...
            try {
                ...
                if (ticket.getCustomer() != null && puntosDataLogic != null) {
                    try {
                        ...
                        try {
                            ...
                            System.out.println("âš ï¸ DEBUG - Error obteniendo puntos del ticket: " + e.getMessage());
                        }
                        ...
                        if (puntosOtorgadosTicket >= 0 && config != null) {
                            ...
                            try {
                                ...
                                if (puntosGanadosHoy >= limiteDiario && puntosOtorgadosTicket == 0) {
                                    ...
                                    System.out.println(
                                            "ðŸš« DEBUG - Límite diario alcanzado (total hoy: " + puntosGanadosHoy
                                                    + ")");
                                } else {
                                    limiteAlcanzado = false;
                                    System.out.println(
                                            "âœ… DEBUG - Puntos otorgados para este ticket: " + puntosOtorgadosTicket);
                                }
                            } catch (Exception e) {
                                limiteAlcanzado = false;
                            }
                            ...
                            System.out.println(
                                    "âš ï¸ DEBUG - No se encontraron puntos en historial, calculando: "
                                            + puntosNuevos);
                            ...
                            if (config == null) {
                                System.out.println("âš ï¸ DEBUG - Configuración de puntos es null");
                            } else if (!config.isSistemaActivo()) {
                                System.out.println("âš ï¸ DEBUG - Sistema de puntos desactivado");
                            }
                            puntosNuevos = 0;
                            limiteAlcanzado = false;
                        }

                        System.out.println("âœ… DEBUG - Puntos finales por compra: " + puntosNuevos);
                ...
                // #endregion
                LOGGER.log(java.util.logging.Level.WARNING,
                        "Exception on processing/Print resource id: " + sresourcename,
                        ex);
                LOGGER.log(java.util.logging.Level.FINE, "Exeception PROCESSED TEMPLATE: \n\r+++++++++++++\n\r "
                        + processTemaplated + "\n\r+++++++++++++\n\r");
                MessageInf msg = new MessageInf(MessageInf.SGN_WARNING,
    ...
    public void printTicket(String resource) {
        LOGGER.log(java.util.logging.Level.FINE, "JPanelTicket printTicket: " + resource);
        if (resource == null) {
    ...
    private void initDeviceDisplay() {
        ...
        if (deviceDisplay != null && deviceDisplay instanceof DeviceDisplayAdvance) {
            ...
            m_ticketlines2.setTicketTableFont(new Font("Segoe UI", Font.PLAIN, 36)); // Fuente moderna y números
                                                                                     // grandes
                                                                                     // - tamaÃ±o aumentado
                                                                                     // en tabla
    ...
    private Object evalScript(ScriptObject scr, String resource, ScriptArg... args) {
        ...
        try {
            ...
            LOGGER.log(java.util.logging.Level.WARNING, "Exception on executing script with resource id: " + resource,
                    ex);
    ...
    private void actualizarVistaPuntosCliente(String clienteId) {
        try {
            ...
            System.out.println(
                    "âœ… Vista de puntos actualizada para cliente " + clienteId + " - Puntos: " + puntosActuales);

        } catch (Exception e) {
            System.err.println("âš ï¸ Error actualizando vista de puntos: " + e.getMessage());
        }
    }

    // Sebastian - Método para actualizar información de puntos del cliente
    private void updateCustomerPointsDisplay() {
        System.out.println("ðŸ” updateCustomerPointsDisplay() called");

        if (m_oTicket.getCustomer() != null) {
            System.out.println("ðŸ“‹ Cliente detectado: " + m_oTicket.getCustomer().getName());

            try {
                // Obtener puntos actuales del cliente
                int puntosActuales = puntosDataLogic.obtenerPuntos(m_oTicket.getCustomer().getId());

                System.out.println("ðŸ’¯ Puntos actuales del cliente: " + puntosActuales);
                ...
                System.out.println("ðŸ’° Total ticket: $" + m_oTicket.getTotal());
                System.out.println("âœ… Total acumulable (solo productos marcados): $" + totalAcumulable);
                ...
                if (config != null && config.isSistemaActivo()) {
                    ...
                    // Debug adicional
                    System.out.println("ðŸ”§ DEBUG - Total acumulable: $" + totalAcumulable);
                    System.out.println("ðŸ”§ DEBUG - Monto por punto: $" + config.getMontoPorPunto());
                    System.out.println("ðŸ”§ DEBUG - Puntos otorgados: " + config.getPuntosOtorgados());

                    // Calcular tramos para mostrar la lógica
                    int tramosCompletos = (int) Math.floor(totalAcumulable / config.getMontoPorPunto());
                    System.out.println("ðŸ”§ DEBUG - Tramos completos: " + tramosCompletos + " (cada tramo = $"
                            + config.getMontoPorPunto() + ")");
                    System.out.println("ðŸ”§ DEBUG - Cálculo por tramos: " + tramosCompletos + " Ã— "
                    ...
                    try {
                        ...
                        System.out.println("ðŸ“Š DEBUG - Puntos ganados hoy: " + puntosGanadosHoy + "/" + limiteDiario);

                        // Ajustar puntos si exceden el límite
                        if (puntosGanadosHoy >= limiteDiario) {
                            puntosNuevos = 0;
                            System.out.println("ðŸš« LÃMITE DIARIO ALCANZADO - No se otorgarán más puntos");
                        } else if (puntosGanadosHoy + puntosNuevos > limiteDiario) {
                            puntosNuevos = limiteDiario - puntosGanadosHoy;
                            System.out.println("âš ï¸ PUNTOS AJUSTADOS por límite diario: " + puntosNuevos);
                        }
                    } catch (Exception ex) {
                        System.err.println("âš ï¸ Error verificando límite diario: " + ex.getMessage());
                    }
                }

                int puntosFuturos = puntosActuales + puntosNuevos;

                System.out.println("ðŸ”® Puntos nuevos a ganar: " + puntosNuevos);
                System.out.println("ðŸŽ¯ Puntos futuros: " + puntosFuturos);

                // Mostrar nombre del cliente y puntos en formato: "Juan Sebastian 360 â†’ 450"
                String nombreCliente = m_oTicket.getCustomer().getName();
                ...
                String textoCompleto = String.format("%s %d â†’ %d",
                        nombreCliente, puntosActuales, puntosFuturos);

                System.out.println("ðŸ“ Texto a mostrar: '" + textoCompleto + "'");

                // Actualizar label en JPrincipalApp (barra superior)
                updatePrincipalAppCustomerPoints(textoCompleto, true);

                System.out.println("âœ… Label actualizado y visible");

            } catch (Exception ex) {
                System.err.println("âŒ Error updating customer points display: " + ex.getMessage());
                ex.printStackTrace();
                LOGGER.log(java.util.logging.Level.WARNING, "Error updating customer points display: ", ex);
                updatePrincipalAppCustomerPoints(m_oTicket.getCustomer().getName(), true);
            }
        } else {
            System.out.println("ðŸš« No hay cliente asignado al ticket");
    ...
    private void initComponents() {
        ...
        jTBtnShow.setFont(new java.awt.Font("Arial", 0, 20)); // NOI18N - TamaÃ±o aumentado
        ...
        m_jbtnScale.setFont(new java.awt.Font("Arial", 0, 18)); // NOI18N - TamaÃ±o aumentado
        ...
        btnReprint1.setFont(new java.awt.Font("Arial", 0, 18)); // NOI18N - TamaÃ±o aumentado
        ...
        jBtnCustomer.setFont(new java.awt.Font("Arial", 0, 20)); // NOI18N - TamaÃ±o aumentado
        ...
        jPanel2.setLayout(new java.awt.GridLayout(3, 1, 5, 15)); // Sebastian - 3 filas para 3 botones con más
                                                                 // espaciado
        ...
        jCheckStock.setFont(new java.awt.Font("Arial", 1, 20)); // NOI18N - TamaÃ±o aumentado
        ...
        m_jPanelLines.setFont(new java.awt.Font("Arial", 0, 20)); // NOI18N - TamaÃ±o aumentado
        // Sebastian - Expandir el panel de líneas para ocupar TODO el ancho disponible
        // (sin barra lateral)
        // Remover el tamaÃ±o preferido limitado para que ocupe todo el espacio
        ...
        m_jPanelLinesSum.setPreferredSize(null); // Sin tamaÃ±o preferido que cree espacio
        m_jPanelLinesSum.setMaximumSize(null); // Sin tamaÃ±o máximo que limite
        ...
        m_jLblCustomerId.setFont(new java.awt.Font("Arial", 1, 17)); // NOI18N - TamaÃ±o aumentado
        m_jLblCustomerId.setText(AppLocal.getIntString("label.customerid")); // NOI18N
        customerInputPanel.add(m_jLblCustomerId);

        m_jCustomerId.setFont(new java.awt.Font("Arial", 0, 17)); // NOI18N - TamaÃ±o aumentado
        ...
        m_jCustomerName.setFont(new java.awt.Font("Arial", 1, 17)); // NOI18N - TamaÃ±o aumentado
        ...
        m_jTicketId.setFont(new java.awt.Font("Arial", 1, 18)); // NOI18N - TamaÃ±o aumentado
        ...
        m_jCustomerPoints.setFont(new java.awt.Font("Arial", 1, 20)); // TamaÃ±o aumentado
        ...
        m_jCustomerPoints.setPreferredSize(new java.awt.Dimension(300, 28)); // TamaÃ±o ajustado para estar al lado de
                                                                             // los botones
        ...
        m_jCustomerPoints.setBorder(javax.swing.BorderFactory.createEmptyBorder(0, 10, 0, 10)); // Solo padding, sin
                                                                                                // borde
        // No aÃ±adir aquí, se aÃ±adirá al customerPointsPanel más adelante
        ...
        // Sebastian - Footer Desarrollado por Websy
        javax.swing.JLabel lblWebsy = new javax.swing.JLabel("Desarrollado por Websy");
        lblWebsy.setFont(new java.awt.Font("Arial", java.awt.Font.ITALIC, 11));
        lblWebsy.setForeground(new java.awt.Color(120, 120, 120));
        lblWebsy.setHorizontalAlignment(javax.swing.SwingConstants.RIGHT);
        lblWebsy.setBorder(javax.swing.BorderFactory.createEmptyBorder(5, 0, 10, 25));
        m_jPanelTotals.add(lblWebsy, java.awt.BorderLayout.SOUTH);
        ...
        // Sebastian - Remover "productos de la venta actual" de aquí, se moverá
        // arriba
        ...
        // Panel de botones pequeÃ±os (F5 Cambiar, Eliminar)
        ...
        btnCambiar.setFont(new java.awt.Font("Arial", java.awt.Font.PLAIN, 16));
        btnCambiar.setPreferredSize(new java.awt.Dimension(110, 28));
        ...
        btnAsignarCliente.setPreferredSize(new java.awt.Dimension(160, 28));
        ...
        leftPanel.add(leftContentPanel, java.awt.BorderLayout.EAST);
        ...
        // juntos
        m_jTotalEuros.setBorder(javax.swing.BorderFactory.createEmptyBorder(0, 5, 0, 0)); // Padding mínimo solo para
                                                                                          // el
        ...
        m_jTotalEuros.setMinimumSize(new java.awt.Dimension(150, 60)); // Mínimo para números pequeÃ±os
        ...
        m_jReprint.setFont(new java.awt.Font("Arial", java.awt.Font.BOLD, 14));
                ...
                if (m_oTicket != null && m_oTicket.getLinesCount() > 0) {
                    ...
                    try {
                        ...
                        if (closeTicket(ticketCerrado, m_oTicketExt)) {
                            ...
                            // Sebastian - Eliminar el ticket cerrado de la lista de pestañas
                            // IMPORTANTE: Primero borrar del sistema base mientras el ticket aÃºn es el
                            // activo "oficial"
                            try {
                                m_ticketsbag.deleteTicket();
                            } catch (Exception e) {
                            ...
                            if (!ventasActivas.isEmpty() && ventaActualIndex >= 0
                                ...
                                LOGGER.log(java.util.logging.Level.FINE, "No quedan tickets, creando uno nuevo");
                                createNewTicket();
                            }
                        ...
                        LOGGER.log(java.util.logging.Level.SEVERE, "Error crítico durante el proceso de cobro", ex);
                        ex.printStackTrace();
        ...
        // Panel para el total con el botón cobrar justo al lado (alineado a la
        // derecha)
        // - estilo Eleventa
        ...
        totalPanel.add(javax.swing.Box.createHorizontalGlue());
        ...
        rightPanel.add(topRightPanel, java.awt.BorderLayout.EAST);
        ...
        // rightPanel (total grande en su posición original + botón cobrar al lado) a
        // la
        // derecha
         ...
         * totalsWithPay.add(payPanel, java.awt.BorderLayout.EAST);
         */
        ...
        bottomContainer.setPreferredSize(null); // Sin tamaÃ±o preferido que cree espacio
        bottomContainer.setMaximumSize(null); // Sin tamaÃ±o máximo que limite
        ...
        m_jPanelLinesSum.add(bottomContainer, java.awt.BorderLayout.EAST);

        // Sebastian - Agregar m_jPanelLinesSum directamente sin espacios
        m_jPanelLines.add(m_jPanelLinesSum, java.awt.BorderLayout.EAST);
        ...
        // Sebastian - Ocultar completamente el panel del teclado numérico para
        // expandir
        // el área de ventas
        ...
        m_jEnter.setPreferredSize(new java.awt.Dimension(35, 40)); // TamaÃ±o ajustado para coincidir con la altura del
                                                                   // campo
        ...
        m_jKeyFactory.setPreferredSize(new java.awt.Dimension(500, 52));
        m_jKeyFactory.setMinimumSize(new java.awt.Dimension(350, 52));
        ...
        m_jKeyFactory.setMargin(new java.awt.Insets(4, 10, 4, 10));

        // Propiedades de FlatLaf para una barra de búsqueda estilo web (forma de
        // píldora)
        m_jKeyFactory.putClientProperty("JTextField.placeholderText",
                "Buscar artículo por nombre, código o código de barras...");
        m_jKeyFactory.putClientProperty("JTextField.showClearButton", true);
        m_jKeyFactory.putClientProperty("JTextField.arc", 999);
        m_jKeyFactory.putClientProperty("JTextField.padding", new java.awt.Insets(0, 15, 0, 15));

        // Estilización extra para asegurar el ancho y aspecto web
        m_jKeyFactory.setPreferredSize(new java.awt.Dimension(850, 52));
        m_jKeyFactory.setMinimumSize(new java.awt.Dimension(600, 52));
        m_jKeyFactory.setMaximumSize(new java.awt.Dimension(1000, 52));

        // Borde redondeado manual (pill-shape) que funciona en cualquier Look and Feel
        m_jKeyFactory.setBorder(javax.swing.BorderFactory.createCompoundBorder(
                new javax.swing.border.Border() {
                    @Override
                    public void paintBorder(java.awt.Component c, java.awt.Graphics g, int x, int y, int width,
                            int height) {
                    ...
                    public java.awt.Insets getBorderInsets(java.awt.Component c) {
                        return new java.awt.Insets(4, 25, 4, 25); // Padding para la píldora
                    }
        ...
        // Estilo web: El panel es solo un wrapper, el redondeo lo da el campo de texto
        // corregido
        searchFieldContainer.setBorder(javax.swing.BorderFactory.createEmptyBorder(0, 0, 0, 0));
        // Estilización extra para asegurar el ancho y aspecto web
        m_jKeyFactory.setPreferredSize(new java.awt.Dimension(850, 52));
        m_jKeyFactory.setMinimumSize(new java.awt.Dimension(700, 52));
        m_jKeyFactory.setMaximumSize(new java.awt.Dimension(1200, 52));

        // Reforzar que el contenedor también sea ancho
        searchFieldContainer.setPreferredSize(new java.awt.Dimension(900, 52));
        searchFieldContainer.setMinimumSize(new java.awt.Dimension(750, 52));
        searchFieldContainer.setMaximumSize(new java.awt.Dimension(1300, 52));
        ...
        // El icono ya está dentro del campo de texto via leadingIcon
        ...
        // Sebastian - Panel indicador de ticket con diseÃ±o elegante tipo eleventa
        ...
        btnAgregarProducto.setPreferredSize(new java.awt.Dimension(280, 52));
        ...
        javax.swing.JButton btnArticuloComun = new javax.swing.JButton("CTRL+P Art. ComÃºn");
        btnArticuloComun.setPreferredSize(new java.awt.Dimension(165, btnHeight));
        ...
        btnArticuloComun.addActionListener(e -> {
            javax.swing.JOptionPane.showMessageDialog(this, "Función Artículo ComÃºn", "Artículo ComÃºn",
                    javax.swing.JOptionPane.INFORMATION_MESSAGE);
        });
        actionButtonsPanel.add(btnArticuloComun);

        // Botón Mayoreo
        /* Botón Mayoreo removido */

        // Botón Entradas
        javax.swing.JButton btnEntradas = new javax.swing.JButton("F7 Entradas");
        btnEntradas.setPreferredSize(new java.awt.Dimension(145, btnHeight));
        btnEntradas.setMinimumSize(new java.awt.Dimension(145, btnHeight));
        btnEntradas.setMaximumSize(new java.awt.Dimension(145, btnHeight));
        ...
        btnSalidas.setPreferredSize(new java.awt.Dimension(115, btnHeight));
        ...
        btnEliminarLinea.setPreferredSize(new java.awt.Dimension(130, btnHeight));
        ...
        btnF4Nueva.setPreferredSize(new java.awt.Dimension(110, btnHeight));
        ...
        // Sebastian - El label de puntos del cliente ahora está en JPrincipalApp
        // (barra
        // superior)
        ...
        searchAndButtonsContainer.add(actionButtonsPanel, java.awt.BorderLayout.EAST);

        searchAndActionsPanel.add(searchAndButtonsContainer, java.awt.BorderLayout.CENTER);

        // Sebastian - Cambiado de EAST a CENTER para que no se desplace todo a la
        // derecha
        topPanel.add(searchAndActionsPanel, java.awt.BorderLayout.CENTER);
        ...
        // de la tabla
        m_jPanelTotals.setPreferredSize(new java.awt.Dimension(0, 110));
        m_jPanelTotals.setVisible(true);
        m_jPanelContainer.add(m_jPanelTotals, java.awt.BorderLayout.SOUTH);
    ...
    private void jEditAttributesActionPerformed(java.awt.event.ActionEvent evt) {// GEN-FIRST:event_jEditAttributesActionPerformed
        ...
        if (i < 0) {
            ...
            try {
                ...
                LOGGER.log(java.util.logging.Level.WARNING, "Exception while Open Product Atribute Editor: ", ex);
            }
        }
    ...
    private void j_btnRemotePrtActionPerformed(java.awt.event.ActionEvent evt) {// GEN-FIRST:event_j_btnRemotePrtActionPerformed
        ...
        try {
            ...
            LOGGER.log(java.util.logging.Level.WARNING, "Exception on executing script: " + scriptId, ex);
        }
                ...
                if (ticketInfo == null) {
                    ...
                    try {
                        ...
                        if (sresource != null) {
                            ...
                            LOGGER.log(java.util.logging.Level.INFO, "Reimpresion completada SIN abrir cajón");
                        } else {
        ...
        if (n == 0) {
            ...
            if (m_customerInfo != null) {
                try {
                    ...
                    LOGGER.log(java.util.logging.Level.WARNING, "Exception on Select Customer: ", ex);
                }
            }
        }
    ...
    private void searchCustomerById() {
        ...
        try {
            ...
            m_jCustomerName.setForeground(new java.awt.Color(200, 0, 0));
            LOGGER.log(java.util.logging.Level.WARNING, "Error searching customer by searchkey: " + customerId, e);
    ...
    private javax.swing.JButton m_jPayNow; // Botón Pagar aÃ±adido
    ...
    // Sebastian - Panel de pestañas para tickets mÃºltiples
    ...
    private void procesarPuntosAutomaticos(TicketInfo ticket) {
        System.out.println("ðŸ”µ procesarPuntosAutomaticos INICIADO - Ticket ID: " + ticket.getTicketId());
        try {
            // Verificar que hay un cliente asignado al ticket
            CustomerInfo cliente = ticket.getCustomer();
            if (cliente == null || cliente.getId() == null) {
                System.out.println("âš ï¸ procesarPuntosAutomaticos: No hay cliente asignado al ticket");
                LOGGER.log(java.util.logging.Level.FINE, "No hay cliente asignado al ticket, no se otorgan puntos");
                return;
            }
            System.out.println("âœ… procesarPuntosAutomaticos: Cliente encontrado: " + cliente.getId());

            // Verificar que el sistema de puntos está activo
            if (puntosDataLogic == null) {
                System.out.println("âš ï¸ procesarPuntosAutomaticos: Sistema de puntos no inicializado");
                LOGGER.log(java.util.logging.Level.WARNING, "Sistema de puntos no inicializado");
                return;
            }
            System.out.println("âœ… procesarPuntosAutomaticos: Sistema de puntos inicializado");

            // Obtener configuración activa del sistema de puntos
            PuntosConfiguracion config = puntosDataLogic.getConfiguracionActiva();
            if (config == null || !config.isSistemaActivo()) {
                System.out.println(
                        "âš ï¸ procesarPuntosAutomaticos: Sistema de puntos desactivado o sin configuración");
                LOGGER.log(java.util.logging.Level.FINE, "Sistema de puntos desactivado");
                return;
            }
            System.out.println("âœ… procesarPuntosAutomaticos: Configuración activa - Monto: $"
            ...
            if (esDevolucion) {
                ...
                if (montoAbsoluto > 0 && ticket.getTicketStatus() > 0) {
                    ...
                    System.out.println("ðŸ”„ DEVOLUCIÃ“N DETECTADA - Ticket original: #" + ticketIdOriginal +
                    ...
                    try {
                        ...
                        System.out.println("âœ… Puntos descontados por devolución exitosamente");
                        ...
                        if (resultado.seDescontaronPuntos()) {
                            mensajeDevolucion = String.format(
                                    "<html><center><h3>âœ… Devolución Procesada</h3>" +
                                            "<p><b>Ticket Original:</b> #%s</p>" +
                                            "<p><b>Cliente:</b> %s</p>" +
                                            "<p><b>Puntos Descontados:</b> %d</p>" +
                                            "<p><b>Puntos Anteriores:</b> %d â†’ <b>Puntos Actuales:</b> %d</p>" +
                        ...
                        System.err.println("âŒ ERROR descontando puntos por devolución: " + ex.getMessage());
                        ex.printStackTrace();
                        LOGGER.log(java.util.logging.Level.SEVERE, "Error descontando puntos por devolución: ", ex);
                    }
                }
            ...
            System.out.println("ðŸ’° procesarPuntosAutomaticos: Total acumulable de esta compra: $" + totalAcumulable);

            // Calcular puntos segÃºn la configuración sobre el monto acumulable (solo para
            // referencia)
            int puntosAOtorgar = config.calcularPuntos(totalAcumulable);

            // Sebastian - Debug adicional para comparar
            System.out.println("ðŸ›’ PROCESAMIENTO REAL - Total ticket: $" + ticket.getTotal());
            System.out.println("ðŸ›’ PROCESAMIENTO REAL - Total acumulable: $" + totalAcumulable);
            System.out.println("ðŸ›’ PROCESAMIENTO REAL - Monto por punto: $" + config.getMontoPorPunto());
            System.out.println("ðŸ›’ PROCESAMIENTO REAL - Puntos otorgados: " + config.getPuntosOtorgados());

            // Mostrar lógica de tramos
            int tramosCompletos = (int) Math.floor(totalAcumulable / config.getMontoPorPunto());
            System.out.println("ðŸ›’ PROCESAMIENTO REAL - Tramos completos: " + tramosCompletos);
            System.out.println("ðŸ›’ PROCESAMIENTO REAL - Cálculo: " + tramosCompletos + " Ã— "
            ...
            String clienteId = cliente.getId();
            System.out.println(
                    "ðŸ”„ LLAMANDO agregarPuntosPorCompra - Cliente: " + clienteId + ", Monto: $" + totalAcumulable);
            try {
                puntosDataLogic.agregarPuntosPorCompra(clienteId, totalAcumulable, descripcion);
                System.out.println("âœ… agregarPuntosPorCompra completado exitosamente");

                // Actualizar vista de puntos del cliente
                actualizarVistaPuntosCliente(clienteId);

            } catch (Exception ex) {
                System.err.println("âŒ ERROR en agregarPuntosPorCompra: " + ex.getMessage());
                ex.printStackTrace();
                LOGGER.log(java.util.logging.Level.SEVERE, "Error otorgando puntos: ", ex);
            }

            // Mostrar notificación opcional al usuario (comentada por defecto)
            /*
             * JOptionPane.showMessageDialog(this,
             * String.format("ðŸŽ‰ Â¡Puntos otorgados!\nCliente: %s\nPuntos: %d",
             * cliente.getName() != null ? cliente.getName() : clienteId,
             * puntosAOtorgar),
             * "Sistema de Puntos",
             * JOptionPane.INFORMATION_MESSAGE);
            ...
            if (ex.getMessage() != null && ex.getMessage().contains("objeto no encontrado")) {
                LOGGER.log(java.util.logging.Level.WARNING, "Tablas de puntos no encontradas, intentando crearlas...");
                try {
                    puntosDataLogic.verificarSistemaPuntos(); // Recrear tablas
                    LOGGER.log(java.util.logging.Level.INFO, "Tablas de puntos creadas, reintentando operación...");
                    ...
                    if (config != null && config.isSistemaActivo()) {
                        ...
                        if (puntosAOtorgar > 0) {
                            ...
                            LOGGER.log(java.util.logging.Level.INFO,
                                    String.format(
                                            "âœ… PUNTOS OTORGADOS (después de crear tablas): Cliente=%s, Total acumulable=$%.2f, Puntos=%d",
                ...
                LOGGER.log(java.util.logging.Level.SEVERE, "Error procesando puntos automáticos: " + ex.getMessage(),
                        ex);
            }
        } catch (Exception ex) {
            LOGGER.log(java.util.logging.Level.SEVERE,
                    "Error inesperado procesando puntos automáticos: " + ex.getMessage(),
                    ex);
        }
    }
    ...
    /**
     * Sebastian - Lista simple para almacenar ventas mÃºltiples
     */
                ...
                if (!wasVisible) {
                    ...
                    javax.swing.SwingUtilities.invokeLater(() -> {
                        javax.swing.JLabel mensaje = new javax.swing.JLabel("<html><div style='text-align: center;'>" +
                                "<b>ï¿½ Lista de Ventas Activas</b><br/>" +
                                "âœ“ Haz clic en cualquier venta para cambiar a ella<br/>" +
                                "âœ“ Haz clic de nuevo en el botón naranja para ocultar<br/>" +
                                "âœ“ Cada venta mantiene sus productos y estado" +
                                "</div></html>");
    ...
    private void mostrarModalIdCliente() {
        try {
            ...
            // Acción de Enter en el campo de búsqueda (buscar y seleccionar si hay un
            // solo
            // resultado)
            txtSearch.addActionListener(e -> {
                ...
                if (!searchText.isEmpty() && table.getRowCount() == 1) {
                    ...
                    // Si hay mÃºltiples resultados, solo seleccionar el primero
            ...
            mainPanel.add(buttonPanel, java.awt.BorderLayout.EAST);
        ...
        try {
                ...
                try {
                    if (savedOrder != null && !savedOrder.isEmpty()) {
                        ...
                        if (orderParts.length == colCount) {
                            ...
                            LOGGER.log(java.util.logging.Level.FINE, "Columnas restauradas: " + savedOrder);
                        }
                    }
                } catch (Exception ex) {
                    LOGGER.log(java.util.logging.Level.WARNING, "Error restaurando columnas: " + ex.getMessage());
                } finally {
            ...
            btnCancelar.addActionListener(e -> {
                try {
                    ...
                    // Sebastian - SIEMPRE pedir contraseÃ±a de administrador para cancelar ventas
                    String sPwd = JPasswordDialog.showEditor(dialog, "ContraseÃ±a de Administrador Requerida");
                    if (sPwd == null) {
                    ...
                    int confirmacion = javax.swing.JOptionPane.showOptionDialog(
                            dialog,
                            String.format(
                                    "<html><center><h3>Â¿Cancelar esta venta?</h3>" +
                                            "<p><b>Ticket:</b> #%d</p>" +
                                            "<p><b>Cliente:</b> %s</p>" +
                                            "<p><b>Total:</b> %s</p>" +
                    ...
                    if (clienteId != null && ticketId > 0 && puntosDataLogic != null) {
                        try {
                            ...
                            LOGGER.log(java.util.logging.Level.WARNING, "Error descontando puntos: " + ex.getMessage());
                        }
                    }
                    ...
                    try {
                        ...
                        String mensajeCancelacion = String.format(
                                "<html><center><h3>âœ… Venta Cancelada</h3>" +
            ...
            btnImprimir.addActionListener(e -> {
                // #region agent log
                try {
                    String logPath = "c:\\Users\\USUARIO\\Downloads\\bicis_mx\\bici\\punto-mx\\app-errors.log";
                ...
                try {
                    ...
                    try {
                        ...
                        // #endregion
                        LOGGER.log(java.util.logging.Level.SEVERE, "Exception on printTicket: Printer.Ticket2", ex);
                        javax.swing.JOptionPane.showMessageDialog(dialog,
    ...
    private void showEntradasSalidasDialog(String tipoFijo) {
        ...
        java.awt.event.ActionListener guardarEntradaSalida = e -> {
            try {
                ...
                LOGGER.log(java.util.logging.Level.SEVERE, "Error al guardar entrada/salida: " + ex.getMessage(), ex);
                javax.swing.JOptionPane.showMessageDialog(dialog,
    ...
    /* El sistema de mayoreo ha sido removido */
    ...
    private void showApartarDialog() {
        ...
        if (m_oTicket.getCustomer() == null) {
            javax.swing.JOptionPane.showMessageDialog(this, "Debe seleccionar un cliente para realizar un apartado.",
                    "Sistema de Apartado", javax.swing.JOptionPane.WARNING_MESSAGE);
            jBtnCustomer.doClick();
            return;
        }

        // Crear diálogo de opciones de apartado
        javax.swing.JDialog dialog = new javax.swing.JDialog(
                (java.awt.Frame) javax.swing.SwingUtilities.getWindowAncestor(this),
                "Configurar Apartado - " + m_oTicket.getCustomer().getName(), true);
        dialog.setSize(450, 300);
        dialog.setLocationRelativeTo(this);

        javax.swing.JPanel panel = new javax.swing.JPanel(new java.awt.GridLayout(4, 1, 10, 10));
        panel.setBorder(javax.swing.BorderFactory.createEmptyBorder(20, 20, 20, 20));

        double subtotal = m_oTicket.getSubTotal();

        javax.swing.JButton btn2meses = new javax.swing.JButton("<html><center>2 Meses (+3%)<br/><b>Extra: "
                + Formats.CURRENCY.formatValue(subtotal * 0.03) + "</b></center></html>");
        javax.swing.JButton btn4meses = new javax.swing.JButton("<html><center>4 Meses (+5%)<br/><b>Extra: "
                + Formats.CURRENCY.formatValue(subtotal * 0.05) + "</b></center></html>");
        javax.swing.JButton btn6meses = new javax.swing.JButton("<html><center>6 Meses (+10%)<br/><b>Extra: "
                + Formats.CURRENCY.formatValue(subtotal * 0.10) + "</b></center></html>");
        javax.swing.JButton btnCancel = new javax.swing.JButton("Cancelar");

        btn2meses.addActionListener(e -> {
            aplicarApartado(2, 0.03);
            dialog.dispose();
        });
        btn4meses.addActionListener(e -> {
            aplicarApartado(4, 0.05);
            dialog.dispose();
        });
        btn6meses.addActionListener(e -> {
            aplicarApartado(6, 0.10);
            dialog.dispose();
        });
        btnCancel.addActionListener(e -> dialog.dispose());
    ...
    private void aplicarApartado(int meses, double recargoPorc) {
        LOGGER.info(">>> [DEBUG APARTADO] Iniciando aplicarApartado. Meses: " + meses + ", Recargo: " + recargoPorc);
        LOGGER.info(">>> [DEBUG APARTADO] Lineas actuales en ticket: " + m_oTicket.getLinesCount());

        // 1. Recorrer todas las líneas para aplicar el recargo al precio
        for (int i = 0; i < m_oTicket.getLinesCount(); i++) {
            TicketLineInfo line = m_oTicket.getLine(i);

            // Solo eliminar líneas auxiliares marcadas explícitamente como recargo de
            // apartado.
            // No debemos borrar productos reales del ticket, aunque usen IDs especiales
            // como Service Charge.
            if ("true".equals(line.getProperty("apartado.extra_line"))
                    || "RECARGO_APARTADO".equals(line.getProperty("apartado.line_type"))) {
                LOGGER.info(">>> [DEBUG APARTADO] Eliminando linea auxiliar de recargo en indice: " + i);
                m_oTicket.removeLine(i);
                i--; // Ajustar índice tras eliminar
                continue;
            }

            // Guardar precio original si no existe para poder revertir/cambiar recargo
            String sOrgPrice = line.getProperty("apartado.original_price");
            double dBasePrice;
            if (sOrgPrice == null) {
                dBasePrice = line.getPrice();
                line.setProperty("apartado.original_price", String.valueOf(dBasePrice));
                LOGGER.info(">>> [DEBUG APARTADO] Guardando precio base: " + dBasePrice + " para producto: "
                        + line.getProductName());
            } else {
                dBasePrice = Double.parseDouble(sOrgPrice);
                LOGGER.info(">>> [DEBUG APARTADO] Usando precio base guardado: " + dBasePrice + " para producto: "
                        + line.getProductName());
            }

            // Aplicar el nuevo precio con recargo
            double nuevoPrecio = dBasePrice * (1.0 + recargoPorc);
            line.setPrice(nuevoPrecio);
            LOGGER.info(">>> [DEBUG APARTADO] Nuevo precio establecido: " + nuevoPrecio + " (Indice: " + i + ")");

            // Actualizar la línea en la UI (puede ser redundante si refreshTicket() se
            // llama después, pero asegura sincronía)
            m_ticketlines.setTicketLine(i, line);
        }

        if (m_oTicket.getLinesCount() == 0) {
            LOGGER.severe(">>> [DEBUG APARTADO] ERROR: el ticket quedó sin líneas después de aplicar el apartado.");
            javax.swing.JOptionPane.showMessageDialog(this,
                    "No se pudo aplicar el apartado porque el ticket quedó vacío.\nRevise los productos del ticket e intente nuevamente.",
                    "Sistema de Apartado", javax.swing.JOptionPane.ERROR_MESSAGE);
            return;
        }

        // 2. Establecer propiedades de Apartado en el ticket
        m_oTicket.getProperties().setProperty("is_apartado", "true");
        m_oTicket.getProperties().setProperty("apartado_meses", String.valueOf(meses));
        m_oTicket.getProperties().setProperty("apartado_porcentaje", String.valueOf(recargoPorc));

        // 3. Actualizar visualización total
        refreshTicket();
        printPartialTotals();
        ...
        javax.swing.JOptionPane.showMessageDialog(this,
                "<html><body style='width: 300px;'>" +
                        "<b>Â¡Precios actualizados para Apartado!</b><br/><br/>" +
                        "â€¢ Plazo: " + meses + " meses<br/>" +
                        "â€¢ Incremento: +" + (int) (recargoPorc * 100) + "% aplicado a cada artículo.<br/><br/>" +
                        "<font color='blue'><b>Nota:</b></font> Los precios se han ajustado automáticamente.<br/><br/>"
                        +
                        "<b>Procesando registro en cuenta del cliente...</b>" +
                        "</body></html>",
                "Apartado Configurado", javax.swing.JOptionPane.INFORMATION_MESSAGE);

        // 5. Sebastian FIX: Ejecutar el proceso de cobro automático a DEUDA
        LOGGER.info(">>> [DEBUG APARTADO] Disparando cobro automático. m_bAutoDebt = TRUE.");
        m_bAutoDebt = true;
        try {
            m_jPayNow.doClick();
        } catch (Exception ex) {
            LOGGER.severe(">>> [DEBUG APARTADO] ERROR al disparar el cobro: " + ex.getMessage());
        } finally {
            m_bAutoDebt = false;
            LOGGER.info(">>> [DEBUG APARTADO] Finalizado proceso de cobro. m_bAutoDebt reset to FALSE.");
        }
    }
