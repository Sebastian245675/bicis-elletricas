...
public class JPaymentCheque extends javax.swing.JPanel implements JPaymentInterface {
    ...
    private void adjustUIComponents() {
        ...
        // 2. Colapsar panel lateral
        if (jPanel2 != null) {
            jPanel2.setPreferredSize(new Dimension(1, 1));
        }
        
        // 3. m_jTendered invisible pero funcional
        if (m_jTendered != null) {
        ...
        // 4. Diseño Limpio / Eleventa
        Dimension fieldSize = new Dimension(450, 90);
        Font labelFont = new Font("Arial", Font.BOLD, 24);
        Font bigFont = new Font("Arial", Font.BOLD, 42);
        ...
        if (jPanel4 != null) {
            ...
            if (jLabel8 != null) {
                ...
                jLabel8.setPreferredSize(new Dimension(180, 90));
            ...
            jPanel4.setPreferredSize(new Dimension(650, 150));
        }
    }
