...
public class JPaymentDebt extends javax.swing.JPanel implements JPaymentInterface {
    ...
    private void adjustUIComponents() {
        ...
        if (m_jTendered != null) {
            ...
            m_jTendered.setPreferredSize(new java.awt.Dimension(1, 1));
            m_jTendered.setFocusable(true);
        }

        // 4. Modernizar campos informativos
        java.awt.Color lightGray = new java.awt.Color(245, 245, 245);
        java.awt.Font fieldFont = new java.awt.Font("Arial", java.awt.Font.BOLD, 16);
        
        if (m_jName != null) {
            m_jName.setBackground(lightGray);
            m_jName.setFont(fieldFont);
            m_jName.setBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(200, 200, 200)));
        }
        
        if (txtMaxdebt != null) {
            txtMaxdebt.setBackground(new java.awt.Color(255, 245, 245));
            txtMaxdebt.setFont(fieldFont);
            txtMaxdebt.setForeground(new java.awt.Color(220, 38, 38));
        }
        
        if (txtCurdebt != null) {
            txtCurdebt.setBackground(lightGray);
            txtCurdebt.setFont(fieldFont);
        }

        if (m_jMoneyEuros != null) {
            m_jMoneyEuros.setFont(new java.awt.Font("Arial", java.awt.Font.BOLD, 36));
            m_jMoneyEuros.setBackground(java.awt.Color.WHITE);
            m_jMoneyEuros.setForeground(new java.awt.Color(52, 152, 219)); // Azul
            m_jMoneyEuros.setBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(52, 152, 219), 2));
        }
    }
