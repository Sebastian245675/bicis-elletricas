...
public class ProductInfoExt {
    ...
    protected String m_sLote;
    protected String m_sModelo;
    protected String m_sColor;
    protected String m_sVoltaje;
    protected String m_sNoSerie;
    ...
    public final void setLote(String sLote) {
        m_sLote = sLote;
    }
    ...
    public final void setModelo(String sModelo) {
        m_sModelo = sModelo;
    }
    ...
    public final void setColor(String sColor) {
        m_sColor = sColor;
    }

    public final String getVoltaje() {
        return m_sVoltaje;
    }
    public final void setVoltaje(String sVoltaje) {
        m_sVoltaje = sVoltaje;
    }

    public final String getNoSerie() {
        return m_sNoSerie;
    }
    public final void setNoSerie(String sNoSerie) {
        m_sNoSerie = sNoSerie;
    }
    ...
    public static SerializerRead<ProductInfoExt> getSerializerRead() {
        return new SerializerRead<ProductInfoExt>() {
            ...
            public ProductInfoExt readValues(DataRead dr) throws BasicException {
                ...
                product.m_sLote = dr.getString(32);
                product.m_sModelo = dr.getString(33);
                product.m_sColor = dr.getString(34);
                product.m_sVoltaje = dr.getString(35);
                product.m_sNoSerie = dr.getString(36);
