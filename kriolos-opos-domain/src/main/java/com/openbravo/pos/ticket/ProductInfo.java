...
public class ProductInfo implements IKeyed {
    ...
    private String m_sLote;
    private String m_sModelo;
    private String m_sColor;
    private String m_sVoltaje;
    private String m_sNoSerie;
    ...
    public static SerializerRead<ProductInfo> getSerializerRead() {
        return new SerializerRead<ProductInfo>() {
            ...
            public ProductInfo readValues(DataRead dr) throws BasicException {
                ...
                prod.m_sLote = dr.getString(10);
                prod.m_sModelo = dr.getString(11);
                prod.m_sColor = dr.getString(12);
                prod.m_sVoltaje = dr.getString(13);
                prod.m_sNoSerie = dr.getString(14);
