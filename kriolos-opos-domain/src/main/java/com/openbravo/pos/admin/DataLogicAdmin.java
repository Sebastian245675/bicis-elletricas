...
public class DataLogicAdmin extends BeanFactoryDataSingle {
    ...
    // compatibilidad
    private static final String DEFAULT_SUPABASE_URL = "https://knysrejfucsooraqbqeq.supabase.co/rest/v1";
    private static final String DEFAULT_SUPABASE_API_KEY = "sb_secret_SnmqV0Botjup71JzZ9s-ZQ_D_IaABBC";
